...
class Keyring {
  constructor(options = {}) {
    ...
    (0, _util.assert)(options && ['ecdsa', 'ed25519', 'sr25519'].includes(options.type || 'undefined'), `Expected a keyring type of either 'ed25519', 'sr25519' or 'ecdsa', found '${options.type}`);
  ...
  addFromAddress(address, meta = {}, encoded = null, type = this.type, ignoreChecksum) {
  ...
  createFromUri(_suri, meta = {}, type = this.type) {
    ...
    const derived = (0, _utilCrypto.keyFromPath)(keypair[type](), path, type);
