...
class Decorate extends _Events.default {
  ...
  _decorateStorageEntry(creator, decorateMethod) {
    ...
    if (creator.iterKey && (creator.meta.type.isMap || creator.meta.type.isDoubleMap)) {
      decorated.entries = decorateMethod((0, _util.memo)(doubleMapArg => this._retrieveMapEntries(creator, doubleMapArg)));
      decorated.entriesPaged = decorateMethod((0, _util.memo)(opts => this._retrieveMapEntriesPaged(creator, opts)));
      decorated.keys = decorateMethod((0, _util.memo)(doubleMapArg => this._retrieveMapKeys(creator, doubleMapArg)));
      decorated.keysPaged = decorateMethod((0, _util.memo)(opts => this._retrieveMapKeysPaged(creator, opts)));
