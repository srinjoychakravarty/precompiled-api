...
function queryAura(api) {
  return api.derive.session.info().pipe((0, _operators.map)(info => createDerive(api, info, [api.registry.createType('u64', 1), api.registry.createType('u64', 1), api.registry.createType('u64', 1), api.registry.createType('SessionIndex', 1)])));
}
...
function progress(api) {
  return (0, _util2.memo)(() => api.consts.babe ? ((0, _util.isFunction)(api.query.staking.erasStartSessionIndex) ? queryBabe(api) // 2.x with Babe
