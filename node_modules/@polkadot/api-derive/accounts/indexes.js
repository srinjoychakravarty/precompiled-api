...
function indexes(api) {
  return (0, _util2.memo)(() => indicesCache ? (0, _rxjs.of)(indicesCache) : (api.query.indices ? (0, _util.isFunction)(api.query.indices.accounts) ? queryAccounts(api).pipe((0, _operators.startWith)({})) : queryEnumSet(api).pipe((0, _operators.startWith)({})) : (0, _rxjs.of)({})).pipe((0, _operators.map)(indices => {
